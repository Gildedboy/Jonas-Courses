...
async function loadFacts() {
  const res = await fetch(
    "https://nvdqyypblbsrfxomkyyu.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im52ZHF5eXBibGJzcmZ4b21reXl1Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2NzgzMDQ3MTIsImV4cCI6MTk5Mzg4MDcxMn0.uoLkR7AusVffZ3Fz-m139na0bdAknzHJHhAE7X8Ei_c",
      },
    }
  );
...
*/
/*
const fact = [`Lisbon is the capital of Portudal`, 2015, true];
console.log(fact);
console.log(fact[2]);
...
//unpack the content of an array using the 3dots and then the name of the array...
